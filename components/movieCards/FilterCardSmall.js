...
export default function FilterCardSmall({props, nav, darkMode, selectFilter, selected}) {
  ...
  return (
    <TouchableOpacity onPress={onPressHandler}>
      <View style={[darkMode?styles.darkCardContainer:Style.lightCardContainer,{ paddingVertical: 6, paddingHorizontal: 8, borderRadius: 4, opacity:selected?0.4:1 }]}>
