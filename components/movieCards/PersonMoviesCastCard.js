...
export default function PersonMoviesCastCard({props, nav, darkMode}) {
  // console.log(props)
    ...
    <TouchableWithoutFeedback onPress={onPressHandler}>
      <View style={[darkMode?Style.darkCardContainer:Style.lightCardContainer,{ height: 68, width: 260, borderRadius: 4, flexDirection: "row" }]}>
        ...
        <View style={{ flex: 1, padding: 4 }}>
          ...
          <MonoTextBold style={darkMode?Style.smallLightText:Style.smallDarkText}>{props.character}</MonoTextBold>
        </View>
      </View>
